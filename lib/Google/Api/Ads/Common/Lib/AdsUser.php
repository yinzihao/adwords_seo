...
abstract class AdsUser {
  ...
  protected function InitLogs() {
    LoggerG::LogToFile(LoggerG::$SOAP_XML_LOG,
        $this->logsDirectory . "/soap_xml.log");
    LoggerG::LogToFile(LoggerG::$REQUEST_INFO_LOG,
        $this->logsDirectory . "/request_info.log");
    LoggerG::SetLogLevel(LoggerG::$SOAP_XML_LOG, LoggerG::$FATAL);
    LoggerG::SetLogLevel(LoggerG::$REQUEST_INFO_LOG, LoggerG::$FATAL);
  }
  ...
  public function LogDefaults() {
    LoggerG::SetLogLevel(LoggerG::$SOAP_XML_LOG, LoggerG::$ERROR);
    LoggerG::SetLogLevel(LoggerG::$REQUEST_INFO_LOG, LoggerG::$INFO);
  }
  ...
  public function LogErrors() {
    LoggerG::SetLogLevel(LoggerG::$SOAP_XML_LOG, LoggerG::$ERROR);
    LoggerG::SetLogLevel(LoggerG::$REQUEST_INFO_LOG, LoggerG::$ERROR);
  }
  ...
  public function LogAll() {
    LoggerG::SetLogLevel(LoggerG::$SOAP_XML_LOG, LoggerG::$INFO);
    LoggerG::SetLogLevel(LoggerG::$REQUEST_INFO_LOG, LoggerG::$INFO);
  }
