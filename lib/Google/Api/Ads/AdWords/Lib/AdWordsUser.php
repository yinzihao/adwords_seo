...
class AdWordsUser extends AdsUser {
  ...
  protected function InitLogs() {
    parent::InitLogs();
    LoggerG::LogToFile(self::REPORT_LOG_CHANNEL_NAME,
        $this->GetLogsDirectory() . DIRECTORY_SEPARATOR
            . self::REPORT_LOG_FILE_NAME);
    LoggerG::SetLogLevel(self::REPORT_LOG_CHANNEL_NAME, LoggerG::$FATAL);
  }
  ...
  public function LogDefaults() {
    parent::LogDefaults();
    LoggerG::SetLogLevel(self::REPORT_LOG_CHANNEL_NAME, LoggerG::$ERROR);
  }
  ...
  public function LogAll() {
    parent::LogAll();
    LoggerG::SetLogLevel(self::REPORT_LOG_CHANNEL_NAME, LoggerG::$INFO);
  }
