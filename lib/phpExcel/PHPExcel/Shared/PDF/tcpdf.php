...
Putting 1 is equivalent to putting 0 and calling Ln() just after. Default value: 0.
	...
	/**
	 * Convert HTML string containing value and unit of measure to user's units oZ Points.
